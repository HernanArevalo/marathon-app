  ...
  return (
    <div
      className={clsx(
        ...
        'text-2xl text-center bg-gray-900 text-white absolute w-[90%] h-[90%] flex flex-col justify-center items-center rounded p-10 fade-in'
      )}
    >
        ...
        <form>
          <label className='block'>
            <input
              ...
              type='file'
              accept='.xlsx, .xls'
              className='text-xl text-white w-fit
