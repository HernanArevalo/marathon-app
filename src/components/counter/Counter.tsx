  ...
  return (
    <>
      <div className='flex flex-col w-fit gap-3'>
        <h1 className='text-5xl font-bold w-full text-left'>TIMER</h1>
        <div
          className={`${orbitron.className} font-bold text-6xl text-center bg-white text-black w-fit p-3 flex flex-row`}
        >
